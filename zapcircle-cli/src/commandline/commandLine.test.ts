...
describe("ZapCircle CLI", () => {
  ...
  it("should handle the `analyze` command", () => {
    ...
    expect(outputData.join(" ")).toContain(
      'Analyzing filetype "jsx" for the path "./src"...',
    );
  });
  ...
  it("should handle the `generate` command", () => {
    process.argv = [
      ...
      "generate",
      "jsx",
      "./path/to/file.zap.toml",
    ];
    program.parse(process.argv);
    expect(outputData.join(" ")).toContain(
      'Generating "jsx" from "./path/to/file.zap.toml"...',
    );
  });
  ...
  it("should handle the `generateTests` command", () => {
    ...
    program.parse(process.argv);
    expect(outputData.join(" ")).toContain(
      'Generating tests "jsx" from "./path/to/file.zap.toml" for "./path/file.jsx"',
    );
  });
